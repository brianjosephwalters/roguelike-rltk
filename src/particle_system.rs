use rltk::{Rltk, RGB};
use specs::{World, Entity, Join, WorldExt, System, Entities, WriteStorage, WriteExpect};
...
impl<'a> System<'a> for ParticleSpawnSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for new_particle in particle_builders.requests.iter() {
            ...
            particles.insert(p, ParticleLifetime { lifetime_ms: new_particle.lifetime }).expect("Unable to insert particle");
        }
